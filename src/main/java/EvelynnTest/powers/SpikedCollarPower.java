...
public class SpikedCollarPower extends Accessory {

    private static final String SIMPLE_NAME = "SpikedCollarPower";
    ...
    public SpikedCollarPower(AbstractCreature owner, int amount, AbstractCard outfit) {
