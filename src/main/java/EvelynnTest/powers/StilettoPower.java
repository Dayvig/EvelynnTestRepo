...
public class StilettoPower extends Accessory {

    private static final String SIMPLE_NAME = "StilettoPower";
    ...
    public StilettoPower(AbstractCreature owner, int amount, AbstractCard outfit) {
