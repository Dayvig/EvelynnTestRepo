...
public class AllurePower extends AbstractEasyPower {

    private static final String SIMPLE_NAME = "AllurePower";
    ...
    public AllurePower(AbstractCreature owner, int amount) {
