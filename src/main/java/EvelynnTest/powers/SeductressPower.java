...
public class SeductressPower extends AbstractEasyPower {

    private static final String SIMPLE_NAME = "SeductressPower";
    ...
    public SeductressPower(AbstractCreature owner, int amount) {
