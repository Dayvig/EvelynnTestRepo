...
public class BlingPower extends Accessory {

    private static final String SIMPLE_NAME = "BlingPower";
    ...
    public BlingPower(AbstractCreature owner, int amount, AbstractCard outfit) {
